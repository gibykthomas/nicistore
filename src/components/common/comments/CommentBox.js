    ...
    render() {
            ...
            if (this.props.comments && this.props.comments.length > 0) {
                ...
                return (
                    <div className="comment-box__no-comments">
                        <Text>
                            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'noComments')}
        ...
        let loginTranslation = (
            <Link className="comment-box__link" to="login" params={routeParams}>
                <Text>
                    <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'login')}
                                      locales={intlStore.getCurrentLocale()} />
                </Text>
            </Link>
        );
        ...
        let registerTranslation = (
            <Link className="comment-box__link" to="register" params={routeParams}>
                <Text>
                    <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'register')}
                                      locales={intlStore.getCurrentLocale()} />
                </Text>
            </Link>
        );
        ...
        return (
            <div className="comment-box">
                <div className="comment-box__comments" itemScope itemType="http://schema.org/UserComments">
                    <Heading size="medium">
                        <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'comments')}
                                          locales={intlStore.getCurrentLocale()}
                ...
                {this.props.user ?
                        ...
                        <div className="comment-box__submit-actions">
                            <div className="comment-box__button">
                                <Button type="primary" onClick={this.handleButtonClick}
                                    ...
                                    &nbsp;
                                    <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'submit')}
                                                      locales={intlStore.getCurrentLocale()} />
                                </Button>
                            </div>
                        </div>
                    ...
                    <div className="comment-box__no-user">
                        <Text>
                            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'noUser')}
                                              locales={intlStore.getCurrentLocale()}
