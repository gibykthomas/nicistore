...
import FormattedMessageWrapper from '../FormattedMessageWrapper/FormattedMessageWrapper';
...
class OrderDetails extends React.Component {
    ...
    render() {
        ...
        let headings = [
            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'nameHeading')}
                              locales={intlStore.getCurrentLocale()} />,
            <span>ID</span>,
            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'skuHeading')}
                              locales={intlStore.getCurrentLocale()} />,
            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'quantityHeading')}
                              locales={intlStore.getCurrentLocale()} />,
            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'priceHeading')}
                              locales={intlStore.getCurrentLocale()} />
        ];
        let rows = this.props.order.checkout.cart.products.map((product) => {
            return {
                data: [
                    <Text size="medium">
                        <FormattedMessageWrapper message={intlStore.getMessage(product.details.name)}
                                          locales={intlStore.getCurrentLocale()} />
                    </Text>,
            ...
            <div className="order-details">
                <div className="order-details__overview">
                        ...
                        <div className="order-details__overview-item">
                            <div className="order-details__overview-item-label">
                                <Text size="medium" weight="bold">
                                    <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'customer')}
                                                      locales={intlStore.getCurrentLocale()} />:
                                </Text>
                            </div>
                    ...
                    <div className="order-details__overview-item">
                        <div className="order-details__overview-item-label">
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'createdAt')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                        </div>
                        <div className="order-details__overview-item-value">
                    ...
                    <div className="order-details__overview-item">
                        <div className="order-details__overview-item-label">
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'id')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                        </div>
                        <div className="order-details__overview-item-value">
                    ...
                    <div className="order-details__overview-item">
                        <div className="order-details__overview-item-label">
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'status')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                        </div>
                        <div className="order-details__overview-item-value">
                ...
                <div className="order-details__detail">
                    <Heading size="medium">
                        <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'billingDetails')}
                                          locales={intlStore.getCurrentLocale()} />
                    </Heading>
                    <div className="order-details__detail-content">
                        ...
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'paymentMethod')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                ...
                <div className="order-details__detail">
                    <Heading size="medium">
                        <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'shippingDetails')}
                                          locales={intlStore.getCurrentLocale()} />
                    </Heading>
                    <div className="order-details__detail-content">
                        <div>
                        ...
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'shippingMethod')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                            ...
                            <br />
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'shippingCost')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                            <Text size="medium">
                ...
                <div className="order-details__detail">
                    <Heading size="medium">
                        <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'products')}
                                          locales={intlStore.getCurrentLocale()} />
                    </Heading>
                    <div className="order-details__detail-content">
                    ...
                    <div className="order-details__detail-content order-details__detail-content--column">
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'subTotal')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                        ...
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'shipping')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                            <FormattedNumber value={this.props.order.checkout.shippingCost}
                        ...
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'vat')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
                        ...
                        <div>
                            <Text size="medium" weight="bold">
                                <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'total')}
                                                  locales={intlStore.getCurrentLocale()} />:
                            </Text>
                            <br />
