            ...
            <div className="admin-homepage-settings">
                <div className="admin-homepage-settings__ordering-block">
                    <div className="admin-homepage-settings__ordering-label">
                        <FormLabel>
                            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'orderBanners')}
                ...
                <div className="admin-homepage-settings__ordering-block">
                    <div className="admin-homepage-settings__ordering-label">
                        <FormLabel>
                            <FormattedMessageWrapper message={intlStore.getMessage(intlData, 'homepageFeaturedCollections')}
                                              locales={intlStore.getCurrentLocale()} />
                        </FormLabel>
                    </div>
                    <div className="admin-homepage-settings__ordering">
