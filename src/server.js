    ...
    try {
        ...
        match({
            ...
            if (error) {
                ...
                context.executeAction(navigateAction, {path: req.originalUrl}, function () {
                    debug('Exposing context state');
                    console.log(app.dehydrate(context));
                    var exposed = 'window.App=' + serialize(app.dehydrate(context)) + ';';
                    let BaseHtmlComponent = React.createFactory(BaseHtml);
                    let html = renderToStaticMarkup(BaseHtmlComponent({
        ...
        let html = ReactDOM.renderToStaticMarkup(ServerErrorComponent());
